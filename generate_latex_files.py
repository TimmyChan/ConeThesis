...
if __name__ == '__main__':
	...
	latex_tabular += 	'\\begin{minipage}{.45\\textwidth}\n\\includegraphics[width=\\textwidth]{"'+experiment_topdown+'/top_sequence SIZE.png"}\n'
	latex_tabular += 	"\\end{minipage} &\n"
	latex_tabular +=	'\\begin{minipage}{.45\\textwidth}\n\\includegraphics[width=\\textwidth]{"'+experiment_bottomup+'/bottom_sequence SIZE.png"}\n'
	latex_tabular += 	"\\end{minipage} \\\\ \\\\\n\\hline \\\\"
	latex_tabular += 	'\\begin{minipage}{.45\\textwidth}\n\\includegraphics[width=\\textwidth]{"'+experiment_topdown+'/top_sequence LENGTH.png"}\n'
	latex_tabular += 	"\\end{minipage} &\n"
	latex_tabular +=	'\\begin{minipage}{.45\\textwidth}\n\\includegraphics[width=\\textwidth]{"'+experiment_bottomup+'/bottom_sequence LENGTH.png"}\n'
	latex_tabular += 	"\\end{minipage}\n\\end{tabular}\n\\end{document}"
